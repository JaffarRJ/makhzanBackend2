...
use App\Http\Requests\Role\DetailRequest;
use App\Http\Requests\Role\ListingRequest;
use App\Http\Requests\Role\StoreRequest;
use App\Http\Requests\Role\AssignRequest;
use App\Http\Requests\Role\UpdateIsActiveRequest;
use App\Http\Requests\Role\UpdateIsShowRequest;
...
class RoleController extends Controller
{
    ...
    public function listing(ListingRequest $request)
    {
        ...
        $roles = $query->paginate($this->pagination);
...
//        return successWithData(GENERAL_FETCHED_MESSAGE, $data);
    ...
    public function edit($id)
    {
        ...
        return view('transaction.edit', compact('role'));
    }
