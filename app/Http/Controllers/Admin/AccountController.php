...
use App\Http\Requests\Account\DeleteRequest;
use App\Http\Requests\Account\DetailRequest;
use App\Http\Requests\Account\ListingRequest;
use App\Http\Requests\Account\StoreRequest;
use App\Http\Requests\Account\UpdateIsActiveRequest;
use App\Http\Requests\Account\UpdateIsShowRequest;
...
class AccountController extends Controller
{
    ...
    public function listing(ListingRequest $request)
    {
        ...
        $accounts = $query->paginate($this->pagination);
