...
use App\Http\Requests\Permission\DetailRequest;
use App\Http\Requests\Permission\ListingRequest;
use App\Http\Requests\Permission\StoreRequest;
use App\Http\Requests\Permission\UpdateIsActiveRequest;
use App\Http\Requests\Permission\UpdateIsShowRequest;
...
class PermissionController extends Controller
{
    ...
    public function listing(ListingRequest $request)
    {
        ...
        $permissions = $query->paginate($this->pagination);
