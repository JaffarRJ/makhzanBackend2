...
@section('tab')
    {{ __('messages.Edit Account')}}
@endsection
@section('title')
    <h1 class="page-title">{{ __('messages.Edit Account')}}</h1>
@endsection
@section('content')
    ...
    @endif
    <form action="{{route('account.update')}}" name="addform" class="card-body" method="POST">
        @csrf
        <div class="row clearfix">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    <textarea name="detail" class="form-control" id="address">{{$account->detail}}</textarea>
