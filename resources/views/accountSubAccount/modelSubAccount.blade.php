<div class="modal fade" id="subAccountModel" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('sub_account.store')}}" name="subAccountForm" class="card-body" method="POST">
                    @csrf
