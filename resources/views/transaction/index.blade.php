...
@section('content')
    <h5 class="card-title">{{ __('messages.Transaction List') }}</h5>
    <a href="{{route('transaction.create')}}" class="btn btn-success"><i class="bi bi-star me-1"></i>{{ __('messages.Create Transaction') }}</a>
    {{--    <button type="button" class="btn btn-primary"  href="{{ route('parties.create') }}"><i class="bi bi-star me-1"></i>{{ __('Create transaction') }}</button>--}}
...
{{--            <th scope="col">#</th>--}}
            <th scope="col">ID</th>
            <th scope="col">{{ __('messages.Transaction Name') }}</th>
...
{{--                    <td></td>--}}
                    ...
                    <td>
                        {{--                        @can('edit')--}}
                        <a href="{{route('transaction.edit',$value->id)}}" class="btn btn-sm btn-primary">{{ __('messages.Edit')}}</a>
